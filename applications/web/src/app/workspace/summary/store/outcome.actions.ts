...
export const DELETE_OUTCOME = "[Summary][Outcome] Delete outcome";
export const SET_FILTER     = "[Summary][Outcome] Set filter";
export const SELECT_PAGE    = "[Summary][Outcome] Select page";
export const PROCESS_PAGE   = "[Summary][Outcome] Process page";
