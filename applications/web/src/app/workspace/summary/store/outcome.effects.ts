...
@Injectable()
export class SummaryOutcomeEffects {
    constructor(
    ...
    processOutput$ = createEffect(() =>
        this._actions$.pipe(
            ...
            concatLatestFrom(() => [
                this._store$.select(selectors.outcome.filter),
    ...
    processPage$ = createEffect(() =>
        this._actions$.pipe(
            ...
            concatLatestFrom(() => [
                this._store$.select(selectors.outcome.page),
                this._store$.select(selectors.outcome.pagesCount),
            ]),
    ...
    selectPage$ = createEffect(() =>
        this._actions$.pipe(
            ...
            concatLatestFrom(() =>
                this._store$.select(selectors.outcome.itemsCount),
            ),
